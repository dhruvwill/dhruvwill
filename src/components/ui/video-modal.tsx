...
>(({ className, children, ...props }, ref) => (
  <VideoModalPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 h-[90vh] w-[90vw] max-w-6xl -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-2xl border border-gray-950/[.1] bg-gray-50/[.2] p-6 dark:border-gray-50/[.1] dark:bg-gray-950/[.5]",
...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "h-auto group relative aspect-video max-w-4xl overflow-hidden rounded-xl border border-gray-950/[.1] object-cover dark:border-gray-50/[.1]",
        isPlaying && "playing",
        className
      )}
...
>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "h-auto max-w-4xl overflow-hidden rounded-xl border border-gray-950/[.1] object-cover shadow-xl dark:border-gray-50/[.1]",
      className
    )}
    {...props}
  >
