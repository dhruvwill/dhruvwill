...
export const BrowserComponent: React.FC<{
  ...
  <div
    className={cn(
      "relative text-sm dark:text-neutral-400 text-neutral-950 border dark:border-neutral-800 rounded-lg w-full h-[400px] dark:shadow-none shadow-lg shadow-gray-200 bg-background overflow-hidden",
      className
    )}
  >
    <div
