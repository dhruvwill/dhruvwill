        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start rtl:justify-end">
            ...
            <a href="/" className="flex ms-2 md:me-24">
              <Logo className="dark:fill-white fill-black h-10 me-2 -rotate-12" />
              <span
                className={`self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white ${ubuntu.className}`}
              >
