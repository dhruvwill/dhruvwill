...
const Hero = (props: Props) => {
  return (
    <div className="py-6 sm:ml-64">
      {/* Edit Below */}
      <div className="max-w-4xl mx-auto p-4 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
        <div>
          <h1 className="text-4xl mt-6 tracking-wider font-cal font-medium text-neutral-600 dark:text-white">
            <span className="block">
              <span className="inline-block relative -left-3 my-1 wave">
                👋
              </span>
            </span>
            Hi, I&apos;m Dhruv
          ...
          <div className="flex flex-col xl:flex-row xl:divide-x dark:divide-gray-700 divide-gray-200">
            <div className="max-w-xl flex flex-col gap-7 pt-6 pr-6">
              <p className="text-neutral-600 dark:text-gray-100">
                I&apos;m a Full Stack Developer and Cloud Engineer with
                expertise in building cross-platform mobile apps. I am
                passionate about creating highly functional, minimal
                applications that can make a significant impact in the
                community.
              </p>
